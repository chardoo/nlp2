...
def hyperparameter_search(data_path, models_dir):
    ...
    try:
        ...
        f1 = train_with_config(data_path, config, models_dir, save_model=False)
    ...
    print(f"\nBest configuration: {best_config} with F1: {best_f1:.4f}")
...
if __name__ == "__main__":
    ...
    best_config, all_results = hyperparameter_search(data_path, models_dir)
    ...
    # Option 3: If you want to skip hyperparameter search and use optimized defaults
    # optimized_config = {
    #     'lr': 2e-5,
    #     'batch_size': 32,
    #     'max_length': 256,
    #     'epochs': 25
    # }
    # final_f1 = train_with_config(data_path, optimized_config, models_dir)
